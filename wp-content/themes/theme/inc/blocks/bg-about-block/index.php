...
class BgAboutBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'bg-about-block',
				'title'             => 'Block: About with background',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/' . 'bg-about-block', GSE()::theme_uri() . $path . '/block.css', array(), 2);
		wp_enqueue_script('theme/' . 'bg-about-block', GSE()::theme_uri() . $path . '/block.js', array(), 2);
		return;
	}
