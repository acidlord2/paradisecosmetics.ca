...
class FaqsBlock
{
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/' . 'faqs-block', GSE()::theme_uri() . $path . '/block.css', array(), 2);
		wp_enqueue_script('theme/' . 'faqs-block', GSE()::theme_uri() . $path . '/block.js', array(), 2);
		return;
	}
