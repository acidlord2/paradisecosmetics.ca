...
class acf_field_yandex_map extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		add_action('acf/input/admin_enqueue_scripts', array($this,'block_script_render'));

	}

	public function block_script_render() {
	...
	function input_admin_enqueue_scripts() {
		...
		$args = array(
			'apikey' => acf_get_setting('yandex_api_key'),
			'lang'   => get_bloginfo( 'language' ),
		);

		wp_register_script( 'yandex-map-api', add_query_arg($args, '//api-maps.yandex.ru/2.1/') , array( 'jquery' ), null );
		...
		// 	'yandex-map-api' => add_query_arg($args, '//api-maps.yandex.ru/2.1/'),
		// 	'acf-yandex'     => $dir.'js/acf-yandex-map.min.js',
		// ));
	}
...
acf_register_field_type( 'acf_field_yandex_map' );
